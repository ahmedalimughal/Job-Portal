...
<head>
    <?php include 'header-links.php'; ?>
        <title><?php echo $website_name; ?> - Contact Forms</title>
    </head>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<script>
$(document).ready(function(){
    $("li#contact-us").addClass("pxp-active");
});
</script>
...
$sql_total = "SELECT COUNT(*) as total FROM `contact-form`";
...
?>
        <div class="pxp-dashboard-content">
            ...
            <div class="pxp-dashboard-content-details">
                <h1>Contact Forms</h1>
                <p class="pxp-text-light">History of all your Contact Forms.</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="pxp-company-dashboard-subscriptions-plan"><?php echo $row['name'] ?></div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="pxp-company-dashboard-job-date"><?php echo $row['message'] ?></div>
                                    </td>
                                    
                                    <td>
                                        <div class="pxp-company-dashboard-job-date"><?php echo $row['country'] ?></div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="pxp-dashboard-table-options">
                                            <ul class="list-unstyled">
                                                <li>
                                                    <a href="delete-contact?id=<?php echo $row['id'] ?>">
